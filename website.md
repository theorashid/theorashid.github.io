...
## work
### code
[numpyro](https://github.com/pyro-ppl/numpyro). Several contributions, including an [example on spatiotemporal modelling](https://github.com/pyro-ppl/numpyro/pull/1295), the [conditional autoregressive distribution](https://github.com/pyro-ppl/numpyro/pull/1394), various [chores](https://github.com/pyro-ppl/numpyro/pull/2150), blog post on [exponential smoothing as state space models](https://juanitorduz.github.io/exponential_smoothing_numpyro_ssm/).
...
[GPJax](https://github.com/JaxGaussianProcesses/GPJax). [Allowing different solve methods](https://github.com/JaxGaussianProcesses/GPJax/pull/478) during approximate sampling, large refactor to move from flax.nnx backend to [Equinox backend with clean numpyro integration](https://github.com/thomaspinder/GPJax/pull/621).
...
[dynestyx](https://github.com/BasisResearch/dynestyx). Large refactor to [remove requirement to use numpyro for inference](https://github.com/BasisResearch/dynestyx/pull/238) allowing optax optimisation for inference, [porting state space examples from dynamax](https://github.com/BasisResearch/dynestyx/pull/267).
...
I'm also interested in [dynamax](https://github.com/probml/dynamax) and [nimble](https://github.com/nimble-dev/nimble), and would like to contribute more when I get some time. If you're a developer of one of those projects and have something I can work on, please get in touch.
